...
import 'package:ecommerce_concept/modules/product_details/ui/widgets/favorites_widget.dart';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => ProductDetailsScreenProvider(
        repository: GetIt.I.get<ProductDetailsRepository>(),
      ),
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    FavoritesWidget(isFavorites: provider.productDetails?.isFavorites ?? false)
                                  ],
                                ),
